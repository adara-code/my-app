...
<li onClick={onclickclose} className='flex flexColumn dashnavcancel' style={{width: '100%', alignItems: 'flex-end'}}>
      <ImCross/>
         ...
         <div className="dashboard-nav-item flex dashboardactive" style={{padding: '20px 40px'}}>
             <RxDashboard style={{fontSize: '24px', marginRight: '10px'}}/>
             <span>DASHBOARD</span>
         </div>
         <div className="dashboard-nav-item flex" style={{padding: '20px 40px'}}>
    ...
    <section>
         <div style={{backgroundColor: '#118924', borderTopRightRadius: '60px', position: "relative"}}>
            <img src={Img1} alt="" />
            <div style={{color: 'white', textAlign: 'center', position: 'absolute', top: '160px', left: '20px'}}>
